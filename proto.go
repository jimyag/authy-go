...
const (
	// ViaMethodPush to receive an Authy app-based push notification
	...
	// RegistrationStatusPending is the status of a pending device registration
	RegistrationStatusPending RegistrationStatus = "pending"
	// RegistrationStatusAccepted is the status of an accepted device registration
	RegistrationStatusAccepted RegistrationStatus = "accepted"
	// RegistrationStatusRejected is the status of a rejected device registration
	RegistrationStatusRejected RegistrationStatus = "rejected"
	// RegistrationStatusFailed is the status of a failed device registration
)
...
// https://api.authy.com/json/users/{User_ID}/devices/registration/{Request_ID}/status?api_key={API_Key}&locale=en-GB&signature={Signature}
